...
import ManWavingHands from "../components/ManWavingHands";
                    ...
                    <div className="w-[35%] flex flex-col items-center justify-between py-3">
                            {
                                contactData.map((data) => {
                                    return(
                                        <div className="flex flex-col items-center justify-center w-44 h-36 bg-white rounded-lg overflow-hidden" key={data.source}>
